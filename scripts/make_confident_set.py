...
for split in ['train', 'val']:
    ...
    write_txt_file = '/home/lisaanne/lev/data2/caption-bias/dataset-splits/%s-confident-man.txt' %split
    write_txt = open(write_txt_file, 'w')
    for image_id in confident_man:
        write_txt.writelines('%s\n' %image_id)
    write_txt_file = '/home/lisaanne/lev/data2/caption-bias/dataset-splits/%s-confident-woman.txt' %split
    write_txt = open(write_txt_file, 'w')
