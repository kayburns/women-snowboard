...
class AnalysisBaseClass:
    ...
    def retrieve_accuracy_with_confidence(self, man_word_list=['man'], woman_word_list=['woman']):
        """
        ...
        for caption_path in caption_paths:
            for confidence in range(1,6):
                ...
                AnalysisBaseClass.retrieve_accuracy_with_confidence_per_model(predictions, confidence)
    ...
    def accuracy(predicted, man_word_list=['man'], woman_word_list=['woman'], img_2_anno_dict_simple=None):
        ...
        # temporarily comment out for python 3 compatibility
        """
